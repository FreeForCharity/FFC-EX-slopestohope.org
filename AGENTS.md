# AI Agent Instructions: FFC-EX-slopestohope.org
...
These sites deploy to `https://freeforcharity.github.io/FFC-EX-slopestohope.org/` and optionally to a custom domain if one is configured for this repo.
