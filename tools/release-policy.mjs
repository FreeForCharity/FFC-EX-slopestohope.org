...
const footerLinks='<span class="sth-footer-links"><a href="/privacy-policy/">Privacy Policy</a><a href="/terms-of-service/">Terms of Service</a></span>';
...
const privacyBody=`<h1>Privacy Policy</h1><p><strong>Effective September 11, 2026</strong></p><p>This policy explains how information is handled when you visit the Slopes to Hope website or use services linked or embedded here.</p><h2>Information you choose to provide</h2><p>The newsletter signup and contact forms are provided by HubSpot. When you submit a form, the information you enter is sent to HubSpot for Slopes to Hope so the organization can manage subscriptions, respond to messages, and maintain related records. The fields shown on each form determine what information is requested.</p><p>Donation and fundraising links take you to third-party services, including Givebutter, RallyUp, and Colorado Gives. Those providers collect and process the information needed for their services under their own terms and privacy policies. Slopes to Hope does not collect payment-card details through this website.</p><h2>Analytics and cookies</h2><p>On the Slopes to Hope production .org website, Google Analytics uses Google tag <code>GT-MKTP8299</code> (measurement ID <code>G-XEWDW3TYVZ</code>) for basic website usage measurement. It does not run on local, preview, or other non-production hosts. Advertising storage, ad-user-data, and ad-personalization are not enabled by default.</p><p>Google Consent Mode applies region-specific defaults. In the configured restricted regions, analytics storage is denied, so normal cookie-based analytics storage is not granted. Google Consent Mode may still send limited cookieless measurement signals when storage is denied. This site does not currently show a global Analytics and privacy popup or provide Accept/Decline analytics controls.</p><p>Standalone HubSpot visitor tracking is not currently enabled. HubSpot forms and third-party content may use their own cookies or similar technologies when they load or when you interact with them. Information you voluntarily submit through HubSpot forms is processed as described above.</p><h2>Hosting and third-party content</h2><p>The site is hosted using GitHub Pages. Hosting and network providers may process routine technical information, such as IP addresses, request details, browser information, timestamps, and security logs, to deliver and protect the site.</p><p>The site also links to or embeds services such as Google Maps, Instagram, Facebook, and other third-party websites. Those services receive information according to their own practices when their content loads or when you follow a link.</p><h2>Choices and contact</h2><p>You can avoid submitting forms and choose whether to visit third-party services. Newsletter messages should provide the applicable subscription-management options.</p><p>For questions about this policy or information submitted to Slopes to Hope, email <a href="mailto:drew@slopestohope.com">drew@slopestohope.com</a> or use the <a href="/contact-us/">contact page</a>.</p><p>This policy may be updated as the website and its services change. The effective date above identifies the current version.</p>`;
