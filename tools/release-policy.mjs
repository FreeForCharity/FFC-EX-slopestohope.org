...
function policyHtml(route,body){return `<!doctype html><html lang="en-US"><head><meta charset="utf-8"><script src="/assets/consent.js"></script><meta name="viewport" content="width=device-width,initial-scale=1"><title>${route.title}</title><meta name="robots" content="max-image-preview:large"><link rel="canonical" href="https://slopestohope.org${route.path}"><meta property="og:url" content="https://slopestohope.org${route.path}"><link rel="stylesheet" href="/assets/policy.css"><link rel="stylesheet" href="/assets/consent.css"></head><body class="sth-policy-page">${header}<main class="sth-policy-main">${body}</main>${footer}</body></html>\n`;}
